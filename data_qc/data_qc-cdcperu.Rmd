...
eess_data <- tibble::tribble(
  ~eess_codigo,	~eess_diresa,	~eess_red,	~eess_microred,	~eess_nombre,	
  ~eess_cat,	~eess_distrito,	~eess_depa,	~eess_prov,
  ~eess_atencion_mes,	~eess_madres,	
  ~eess_jefes_eess,	~eess_personal,
...
# eess_data %>% select(eess_depa:eess_personal)
# eess_data
```
...
eess_data_show$eess_atencion_mes <- 
  color_tile("white", "orange")(eess_data_show$eess_atencion_mes)
eess_data_show$eess_madres <- 
  color_bar("lightgreen")(eess_data_show$eess_madres)
```
