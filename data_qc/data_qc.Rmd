...
# MAYUS <- dplyr::bind_rows(palmerpenguins::penguins,palmerpenguins::penguins[1:3,])
# dplyr::bind_rows(palmerpenguins::penguins,palmerpenguins::penguins[1:3,]) %>% readr::write_csv("palmer_test.csv")
